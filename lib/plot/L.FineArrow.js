L.FineArrow = L.Polygon.extend({
    ...
    generate: function() {
        ...
        var pList = [tailLeft, neckLeft, headLeft, [pnt2[0],pnt2[1]], headRight, neckRight, tailRight];
        this._setLatLngs(L.PlotUtils.pointsTolatlngs(pList));
        this.redraw();
    },
...
L.fineArrow = function(latlng, radii, tilt, options) {
    return new L.FineArrow(latlng, radii, tilt, options);
};